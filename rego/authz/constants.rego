...
_missing_type_label := "Access Denied: To query logs you need to provide the label \"type\" with either \"application\", \"infrastructure\" or \"audit\"."
